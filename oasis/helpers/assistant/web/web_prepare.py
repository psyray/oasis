...
assembly (see :func:`oasis.helpers.assistant.prompt.chat_context.assemble_verdict_first_prompt`):
...
from .rag import json_finding_slice
from ..scan.scan_aggregate import (
...
from ...executive.assistant_scope import resolve_aggregate_finding_scope_payload
...
def build_report_summary_payload(
    *,
    ...
    :data:`oasis.helpers.assistant.prompt.prompt_tuning.REPORT_SUMMARY_AGGREGATE_MERGE_BUDGET_FACTOR`);
