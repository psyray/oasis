...
This helper complements :mod:`oasis.helpers.assistant.scan.trace`. While the trace
...
from .scan_utils import read_text_safely
from oasis.helpers.vuln.validation_patterns import SINKS, SOURCES
