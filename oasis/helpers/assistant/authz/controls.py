"""High-level wrapper around :mod:`oasis.helpers.assistant.authz.authz` for composite controls.

Where :mod:`oasis.helpers.assistant.authz.authz` exposes low-level hits, this module bundles the
