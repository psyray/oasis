...
Validation JSON compaction: :mod:`oasis.helpers.assistant.verdict.verdict_validation`.
Label hard-cap: :mod:`oasis.helpers.assistant.prompt.prompt_shrink`.
Tuning: :mod:`oasis.helpers.assistant.prompt.prompt_tuning`.
"""
...
from ..prompt.prompt_shrink import (
