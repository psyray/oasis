...
:mod:`oasis.helpers.assistant.verdict.verdict_assembly`; label-truncation hard cap in
:mod:`oasis.helpers.assistant.prompt.prompt_shrink`. Tuning: :mod:`oasis.helpers.assistant.prompt.prompt_tuning`.
"""
...
from ..prompt.prompt_tuning import (
...
def compact_validation_for_chat(
    ...
    *,
    ...
    :data:`oasis.helpers.assistant.prompt.prompt_tuning.CHAT_VALIDATION_LIST_CAPS` (or a
...
def _fit_validation_to_budget(
    ...
    *,
    ...
    :data:`oasis.helpers.assistant.prompt.prompt_tuning.VALIDATION_MAX_RATIO`) by
    :func:`oasis.helpers.assistant.verdict.verdict_assembly.assemble_verdict_first_prompt` in
    :mod:`oasis.helpers.assistant.verdict.verdict_assembly`.
    """
    stats: Dict[str, Any] = {
...
def serialize_finding_validation(validation: Dict[str, Any]) -> str:
    ...
    (both invoked by :func:`oasis.helpers.assistant.verdict.verdict_assembly.assemble_verdict_first_prompt`).
    """
