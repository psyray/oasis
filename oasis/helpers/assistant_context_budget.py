...
def assistant_total_system_budget_chars(
    *,
    ...
    :func:`oasis.helpers.assistant_prompt_tuning.resolve_assistant_chars_per_token_guess`
    (default + :data:`oasis.helpers.assistant_prompt_tuning.ASSISTANT_CHARS_PER_TOKEN_BY_MODEL_PREFIX`).
    """
