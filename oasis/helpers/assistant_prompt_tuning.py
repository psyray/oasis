...
string literals. :mod:`oasis.helpers.assistant_chat_context` re-exports
assembly APIs from :mod:`oasis.helpers.assistant_verdict_assembly` and
validation from :mod:`oasis.helpers.assistant_verdict_validation` for
backward-compatible imports. :mod:`oasis.helpers.assistant_report_excerpt`
consumes compact sizing from here.

**Also documented elsewhere (not duplicated here):**
  - :mod:`oasis.helpers.assistant_context_budget` — dynamic char clamp,
    :class:`~oasis.helpers.assistant_context_budget.AssistantBudgetMeta`
  - :mod:`oasis.helpers.assistant_prompt_shrink` — label-boundary hard cap config
...
# ``chars_per_token_guess`` to :func:`oasis.helpers.assistant_context_budget.assistant_total_system_budget_chars`.
...
# Aggregate merge in :func:`oasis.helpers.assistant_web_prepare.build_report_summary_payload`
# needs a **temporary** per-merge char budget. This factor × the final report-summary
# subbudget gives merge headroom; :func:`oasis.helpers.assistant_report_excerpt.compact_report_excerpt`
